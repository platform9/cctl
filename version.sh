...
# Changes: Updated location of version to  github.com/platform9/cctl/vendor/k8s.io/kubernetes/pkg/version
...
kube::version::ldflag() {
  ...
  echo "-X github.com/platform9/cctl/vendor/k8s.io/kubernetes/pkg/version.${key}=${val}"
}
